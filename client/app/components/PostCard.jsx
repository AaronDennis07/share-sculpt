...
const PostCard = () => {
  return (
    <article className="flex items-center  w-7/12 bg-white    border-[1px] rounded-xl border-slate-900 p-4 mt-12">
      <div>
        ...
        <div className='flex items-center'>     
          ...
          <Link href="/posts/123/edit" className='mt-10 flex items-center w-20   justify-evenly pl-4'>
            <AiOutlineEdit />
            <p  className='text-sm'>Edit</p>
          </Link>
          <Link href="/posts/123/edit" className='mt-10 flex items-center w-20 justify-evenly '>
            <AiOutlineDelete />
